...
import com.automed.interstitial.api.AMInterstitial;
import com.automed.interstitial.api.AMInterstitialListener;
...
//        mCurrentSelectIndex = 9;
    ...
    private void init() {
        ...
        mInterstitialAd = new AMInterstitial(this, unitIds[mCurrentSelectIndex]);
        addSetting();
